...
st.title("🗺️ Kerala Local Body Election Explorer")
...
with tab1:
    st.subheader("🏅 Total Seats Won by Front and LBType")
    ...
    st.dataframe(front_pivot, use_container_width=True, hide_index=True)
